...
export function ArticleCard({
  ...
  return (
    <article className="bg-white border border-border rounded-lg p-4 sm:p-6 hover:shadow-green transition-all duration-200 hover:-translate-y-1 flex flex-col">
